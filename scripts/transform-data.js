...
// src/iso-8859-8.src.mjs → iso-8859-8.mjs
const LIB_TEMPLATE = fs.readFileSync('./src/iso-8859-8.src.mjs', 'utf8');
const createLib = template(LIB_TEMPLATE, TEMPLATE_OPTIONS);
const libCode = createLib(require('./export-data.js'));
fs.writeFileSync('./iso-8859-8.mjs', libCode);

// src/iso-8859-8.d.ts → iso-8859-8.d.ts
const TYPES_TEMPLATE = fs.readFileSync('./src/iso-8859-8.d.ts', 'utf8');
const createTypes = template(TYPES_TEMPLATE, TEMPLATE_OPTIONS);
const typesCode = createTypes(require('./export-data.js'));
fs.writeFileSync('./iso-8859-8.d.ts', typesCode);
